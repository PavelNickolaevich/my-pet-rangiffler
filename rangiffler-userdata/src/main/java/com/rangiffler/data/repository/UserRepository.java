...
public interface UserRepository extends JpaRepository<UserEntity, UUID> {
    ...
    @Query("select u from UserEntity u join FriendsEntity f on u = f.friend" +
            " where f.status = com.rangiffler.model.FriendStatus.FRIEND and f.user = :requester")
    ...
    @Query("select u from UserEntity u join FriendsEntity f on u = f.friend" +
            " where f.status = com.rangiffler.model.FriendStatus.INVITATION_SENT and f.user = :requester")
    ...
    @Query("select u from UserEntity u join FriendsEntity f on u = f.user" +
            " where f.status = com.rangiffler.model.FriendStatus.INVITATION_RECEIVED and f.friend = :addressee")
